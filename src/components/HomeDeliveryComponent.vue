<template>
    <section id="home_delivery">
        <div class="home_delivery_section mk_container">
            <div class="home_delivery_section_img"></div>
            <div class="infos">
                <h3>Superfast Product<br>Delivery System</h3>
