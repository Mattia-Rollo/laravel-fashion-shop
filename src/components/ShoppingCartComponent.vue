  ...
  <div class="shopping_cart">
    <div class="mk_container">
      ...
      <div class="product_list mt-5">
        <div
          class="cart_item d-flex py-3 justify-content-between align-items-center"
          v-for="(cartItem, index) in store.shoppingCart"
          :key="index"
        >
          <div>
            <p>{{ cartItem.name }}</p>
            <p>{{ cartItem.price_sign }}{{ cartItem.price }}</p>
            <input type="number" class="w-25 me-2" @change="" />
